...
class EmpresaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $empresas = $em->getRepository('SaarBundle:Empresa')->findAll();
    ...
    {
        $empresa = new Empresa();
        $form = $this->createForm('SaarBundle\Form\EmpresaType', $empresa);
    ...
    {
        $deleteForm = $this->createDeleteForm($empresa);
        $editForm = $this->createForm('SaarBundle\Form\EmpresaType', $empresa);
